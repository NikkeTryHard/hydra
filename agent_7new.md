After the sequential core-doc read you asked for, then code-grounding, then outside retrieval, I end with **2 surviving candidates**. I do **not** think a third survives without quietly leaning on reserve-shelf dependencies.
