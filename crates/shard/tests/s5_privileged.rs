...
use hydra_shard::{
    ACTOR_FIELDS, ActionTable, PrivilegedRow, RowProvenance,
...
///
/// Test-local copy of the frozen `FORBIDDEN_IN_ACTOR` vocabulary (mirrors
/// `src/hydra2/data/parquet.py`; the deleted root handoff carried the Rust
/// copy). Kept here — not in the shard API — because only this leakage
/// battery pins the list.
const FORBIDDEN_IN_ACTOR: [&str; 6] = [
    "hidden_tiles",
    "wall",
    "dead_wall",
    "opponent_hand",
