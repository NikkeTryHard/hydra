...
impl ColdSidecar {
    ...
    pub fn neutral_from_hot(hot: &HotRow<'_>) -> Result<Self, Full26Error> {
        ...
        // proof: bounds-checked 0..=32 above, fits usize.
        ...
        while k < n {
            ...
            // proof: LEGAL_BITS 6792 fits in i64.
            #[allow(clippy::cast_possible_wrap)]
            if id < 0 || id >= LEGAL_BITS as i64 {
                return Err(Full26Error::BadLegalId { id });
            }
            // proof: bounds-checked 0 <= id < 6792 above, fits usize.
            #[allow(clippy::cast_possible_truncation, clippy::cast_sign_loss)]
            {
...
pub fn encode_compact_row(
    ...
    // proof: history lengths <=32 fit in u16.
    ...
    // proof: kan counts 0..4 fit in u8 without sign loss.
    #[allow(clippy::cast_possible_truncation, clippy::cast_sign_loss)]
