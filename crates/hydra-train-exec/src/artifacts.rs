...
mod wrapper_moved_tests {
    ...
    use crate::progress::{RlStepLogEntry, ScalarAverages};
    ...
    type EpochLogEntry = crate::progress::EpochLogEntry<DeltaQPromotionSnapshot, RuntimeAdvisory>;
    type StepLogEntry = crate::progress::StepLogEntry<DeltaQPromotionSnapshot, RuntimeAdvisory>;
    ...
    fn append_rl_step_log(path: &Path, entry: &RlStepLogEntry) -> Result<(), String> {
