...
mod tests {
    ...
    fn calc_returns_non_win_for_incomplete_hand() {
        let eval =
            HandEvaluator3P::new(&[0, 4, 8, 36, 40, 44, 72, 76, 80, 108, 112, 116, 120], &[]);
    ...
    fn calc_counts_sanma_dora_ura_and_kita() {
        let eval = HandEvaluator3P::hand_from_text("111m123p123s111z22z")
            .expect("winning hand should parse");
