    ...
    I: IntoIterator<Item = String>,
{
    ...
    let python_learner = if route_python_bc {
        ...
        Some(PythonLearnerCliOptions {
            ...
            raw_mjai_worker_threads: crate::config_runtime::default_num_threads_for_system(),
            raw_mjai_prefetch_batches: super::default_shard_prefetch_depth(),
            raw_mjai_queue_bound: super::default_archive_queue_bound(),
