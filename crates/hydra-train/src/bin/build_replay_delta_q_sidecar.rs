...
use hydra_train::training::replay_delta_q::{
    replay_delta_q_records_for_identity, ReplayDeltaQRecordV1,
};
    ...
    I: IntoIterator<Item = String>,
{
    ...
    let program = args
        .next()
        .unwrap_or_else(|| "build_replay_delta_q_sidecar".to_string());
...
fn write_jsonl(path: &Path, records: &[ReplayDeltaQRecordV1]) -> Result<(), String> {
