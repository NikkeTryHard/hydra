...
//!
//! Canonical backend-free shard manifest, host batch, reader, and writer code lives in
//! `hydra-bc-shards`.  This module keeps the historical `hydra_train::data::bc_shards`
//! path available while Burn tensor materialization lives in `hydra-train-exec`.
