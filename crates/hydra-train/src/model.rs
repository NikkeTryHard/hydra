...
//!
//! The canonical Burn model implementation lives in `hydra_model::model`.

pub use hydra_model::model::{
    ActorNet, HydraForwardPolicy, HydraModel, HydraModelConfig, HydraOutput, LearnerNet,
    ModelAdvancedHead,
};

use crate::training::{head_gates::AdvancedHead, losses::HydraLossConfig};
...
/// Training-crate extension methods for invoking hydra-model forwards with train-local config types.
