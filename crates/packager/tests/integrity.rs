...
//! bytes.
// `row_for` asserts through `panic!` by design (see clippy.toml: "Tests keep
// unwrap/expect/panic/prints"); `allow-panic-in-tests` only covers `#[test]`
// bodies, not shared helpers.
#![allow(clippy::panic)]
