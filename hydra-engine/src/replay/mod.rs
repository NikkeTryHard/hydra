        ...
        loop {
            ...
            match action {
                ...
                Action::ChiPengGang {
                    ...
                    let env_action = EnvAction::new(env_action_type, t, tiles, None);
                ...
                Action::AnGangAddGang {
                    ...
                    let env_action = match atype {
                        ...
                        _ => {
                            ...
                            EnvAction::new(atype, tile, tiles, None)
                        }
                    };
                ...
                Action::Hule { hules } => {
                    ...
                    let env_action = EnvAction::new(atype, tile, &[], None);
            ...
            match action {
                ...
                Action::Hule { hules } => {
                    for hule_data in hules {
                        ...
                        let actual_result = {
                            let calc = HandEvaluator::new(&hand_136, &melds_136);
                            calc.calc(
                                win_tile,
                                &dora_indicators,
                                &ura_indicators,
...
impl WinResultContext {
    ...
    pub fn create_calculator(&self) -> HandEvaluator {
        HandEvaluator::new(&self.tiles, &self.melds)
    }
