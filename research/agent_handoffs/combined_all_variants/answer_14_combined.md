...
4. The first promoted version should remain discard-centric and local; it should not pretend to solve opponent dynamics. ([GitHub][2])
...
That last line is the semantic mismatch with the doc’s intended `E[score \mid win, a]`. ([GitHub][3])
