...
- use search/browse aggressively: find the original paper, adjacent papers, official docs, repos, and other primary sources that might change the candidate set; use abstracts or summaries mainly for discovery, not as the final evidence base
