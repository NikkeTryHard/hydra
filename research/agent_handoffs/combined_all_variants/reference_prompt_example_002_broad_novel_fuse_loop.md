Load caveman-compress rules. Then compress only natural language.<combined_run_record run_id="reference_example_002" variant_id="broad_novel_fuse_loop" schema_version="1">
<metadata>
...
- if claiming path works, survives, or is impl-ready, show why confidence justified and how claim can be validated/falsified later
...
<artifact_note>
Artifacts below reflect what current codebase/docs seem say now. Not guaranteed correct. Treat as evidence to inspect/critique, not inherited truth. High chance some incomplete, misleading, stale, or semantically wrong, so validate all.
</artifact_note>
