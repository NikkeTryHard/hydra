<combined_run_record run_id="prompt_2_repo_aware_next_tranche" variant_id="prompt_template" schema_version="1">
  <metadata>
  ...
  <prompt_section>
  <prompt_text status="preserved" source_path="research/agent_handoffs/prompts/PROMPT_2_REPO_AWARE_NEXT_TRANCHE.md" kind="prompt_template">
  <![CDATA[# Hydra breakthrough prompt 2 — repo-aware next tranche
