<combined_run_record run_id="answer_24" variant_id="prompt_config_answer_compact" schema_version="1">
  <metadata>
    <notes>Compact self-contained combined record for Agent 24 replay/sample ExIt producer-path research. It preserves the compact prompt shell and artifact manifest reconstructed from the authoritative generator config, plus the preserved Agent 24 answer.</notes>
