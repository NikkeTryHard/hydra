<combined_run_record run_id="prompt-6" variant_id="prompt_pack" schema_version="1">
  <metadata>
  ...
  <prompt_section>
  <prompt_text status="preserved" source_path="prompt-6.md" kind="multi_variant_prompt_pack">
  <![CDATA[# Hydra long-think prompt pack 6 — invention, synthesis, and prototype pressure
