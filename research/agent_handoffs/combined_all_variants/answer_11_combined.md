...
This exactly mirrors what the bridge already does in expectation when it sums CT-SMC hidden columns into remaining counts; the difference is that we do it per world instead of after first-moment averaging. ([GitHub][10])
