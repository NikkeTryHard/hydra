...
use crate::hydra2_row::{ChosenAction, ReplayRow};
...
fn table_content_digest(schema_version: &str, templates: &[Template]) -> String {
    ...
    crate::hydra2_row::digest_text(&crate::hydra2_row::canonical_json_bytes(&doc))
}
...
pub fn walk_game_with_version(
    ...
    let wall_digest: Option<String> = match &game.wall_tiles {
        ...
        Some(tiles) => {
            ...
            let schedule = crate::hydra2_row::schedule_id_for(&game.game_id);
            Some(crate::hydra2_row::wall_schedule_digest(&schedule, tiles))
        }
    };
