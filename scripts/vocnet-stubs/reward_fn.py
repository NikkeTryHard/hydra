"""
VocNet reward function.

Computes reward signals from expert annotation quality scores for
reinforcement learning training. The reward function translates
raw annotation agreement metrics into shaped rewards that encourage
the model to produce classifications matching expert consensus.
"""
