...
_CANONICAL_RULES_ID: str = _bridge_contracts.RULES_ID  # reason: canary
...
WALL_TILE_COUNT = int(getattr(_bridge_contracts, "RECORD_WALL_TILE_COUNT", 136))
...
class EngineIdentity:
    ...
    def __post_init__(self) -> None:
        ...
        env_hash: DigestText = _bridge_contracts.make_digest_text(self.environment_hash)
        object.__setattr__(self, "environment_hash", env_hash)
...
class SimulatorSnapshot:
    ...
    def __post_init__(self) -> None:
        ...
        snapshot_hash: DigestText = _bridge_contracts.make_digest_text(self.rules_hash)
        object.__setattr__(self, "rules_hash", snapshot_hash)
