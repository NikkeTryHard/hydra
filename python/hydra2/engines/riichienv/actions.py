...
def _action(
    ...
    *,
    ...
    tile_bound: TileId | None = None if tile is None else _bridge_contracts.make_tile_id(tile)
    called_bound: TileId | None = (
        None if called_tile is None else _bridge_contracts.make_tile_id(called_tile)
    )
    source_bound: Seat | None = None if source is None else _bridge_contracts.make_seat(source)
