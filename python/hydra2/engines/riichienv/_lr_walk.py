...
from hydra2.engines.riichienv._lr_frame import (
    _packet_boundary_hash as _packet_boundary_hash,
)
...
def _pop_window_heads(
    ...
    """
    del kyoku
    pai: str = tiles.mjai_string_of(tile)
...
def _fresh_builder(state: _GameState) -> ObservationBuilder:
    ...
    """
    rules_bound: DigestText = _bridge_contracts.make_digest_text(state.rules_hash)
