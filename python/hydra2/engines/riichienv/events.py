...
def make_envelope(
    *,
    ...
    checked_kind = cast("EventKind", _require_enum(kind, name="kind", allowed=kinds))
    ...
    rules_digest: DigestText = _bridge_contracts.make_digest_text(rules_hash)
    schema_digest: DigestText = _bridge_contracts.make_digest_text(schema_hash)
