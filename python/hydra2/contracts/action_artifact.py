...
ACTION_TABLE_ARTIFACT_TYPE: str = _bridge_contracts.ACTION_TABLE_ARTIFACT_TYPE
_ACTION_TABLE_SCHEMA_VERSION_TEXT: str = _bridge_contracts.ACTION_TABLE_SCHEMA_VERSION
ACTION_TABLE_SCHEMA_VERSION = SchemaVersion(_ACTION_TABLE_SCHEMA_VERSION_TEXT)
_ACTION_TABLE_RELPATH_TEXT: str = _bridge_contracts.ACTION_TABLE_RELPATH
ACTION_TABLE_RELPATH = Path(_ACTION_TABLE_RELPATH_TEXT)

_TEMPLATE_JSON_FIELDS: tuple[str, ...] = _bridge_contracts.TEMPLATE_JSON_FIELDS
