...
OBSERVATION_SCHEMA_ARTIFACT_TYPE: str = _bridge_contracts.OBSERVATION_SCHEMA_ARTIFACT_TYPE
OBSERVATION_SCHEMA_SCHEMA_VERSION: str = _bridge_contracts.OBSERVATION_SCHEMA_SCHEMA_VERSION
OBSERVATION_SCHEMA_RELPATH = Path("configs") / "contracts" / "observation_schema_v1.json"

_OBSERVATION_SCHEMA_ENVELOPE_FIELDS: tuple[str, ...] = (
    _bridge_contracts._OBSERVATION_SCHEMA_ENVELOPE_FIELDS
)
