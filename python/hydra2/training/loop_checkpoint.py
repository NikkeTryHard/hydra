...
class SupervisedLoopCheckpointMixin:
    ...
    def evaluate_report(
        ...
        *,
        ...
        """Frozen-model eval report (body lives in ``loop_eval_report``)."""
        from hydra2.training.loop_eval_report import evaluate_report as _report

        return _report(self, eval_batches, weights=weights)
