...
FIXED_HISTORY_T = int(_contracts_const("RECORD_FIXED_HISTORY_T", 256))

#: Extra plane carrying per-row true history lengths (mask sums at build).
HISTORY_LEN_PLANE = str(_contracts_const("RECORD_HISTORY_LEN_PLANE", "history_len"))
...
DECISION_IDS_FILENAME = str(_contracts_const("RECORD_DECISION_IDS_FILENAME", "decision_ids.json"))
OBSERVATION_HASHES_FILENAME = str(
    _contracts_const("RECORD_OBSERVATION_HASHES_FILENAME", "observation_hashes.json")
)
