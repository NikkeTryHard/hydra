...
if TYPE_CHECKING:
    from hydra_learner.checkpointing.core import OptimizerConfig
    from hydra_learner.model.losses import LossWeights
    from hydra_learner.typing_boundaries import TorchCheckpointPayload
...
def _validate_checkpoint_root(checkpoint: TorchCheckpointPayload) -> None:
    required = {
        "schema_version",
        "torch_version",
        "cuda_version",
