...
from hydra_learner.data.shard_contracts import ACTION_SPACE, NUM_CHANNELS, TILE_WIDTH, PolicyBatch
from hydra_learner.model.losses import BaseTargets, LossWeights

if TYPE_CHECKING:
    from hydra_learner.data.raw_mjai import PinnedPolicyBatch
    from hydra_learner.data.raw_mjai.direct import RawMjaiDirectStream
    from hydra_learner.data.raw_mjai.pinned import RawMjaiPinnedStream
    from hydra_learner.data.shard_reader import BcShardDataset
