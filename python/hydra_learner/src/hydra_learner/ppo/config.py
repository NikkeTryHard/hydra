...
from hydra_learner.ppo.compat import _compatible_resume_config_digests, _config_digest, _json_config
...
def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    ...
    parser.add_argument("--rollout-inference", choices=("torch-callback", "rust-ort", "mahjax-gpu"))
...
def validate_args(args: argparse.Namespace) -> PpoControlConfig:
    ...
    rollout_inference = args.rollout_inference or "mahjax-gpu"
