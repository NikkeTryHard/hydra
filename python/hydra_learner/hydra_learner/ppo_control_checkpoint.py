...
from hydra_learner.optim import adamw_flag_value
from hydra_learner.ppo_control_config import OBJECTIVE, RANK_UTILITY, PpoControlConfig
...
def _optimizer_config(config: PpoControlConfig) -> OptimizerConfig:
    return OptimizerConfig(
        ...
        schedule_total_steps=config.steps,
